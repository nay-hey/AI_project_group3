...
if isinstance(BLOCK_SIZE, int):
    if BLOCK_SIZE < 6:
        ...
        BLOCK_SIZE = BLOCK_SIZE - int(BLOCK_SIZE % 2)
...
class Draw:
    ...
    def draw_main_screen(self):
        ...
        self.draw_text_with_highlight("PRESS  R  : RANDOM BLOCK", (self.boardWidth // 2 - 3) * BLOCK_SIZE,
                                    ((self.board.GRID_HEIGHT / 2) + self.boardOffset + 1) * BLOCK_SIZE,
                                    highlight_color=(100, 190, 200))

        self.draw_text_with_highlight("PRESS  I  :  AI GENERATED", (self.boardWidth // 2 - 4) * BLOCK_SIZE,
                                    ((self.board.GRID_HEIGHT / 2) + 2 * self.boardOffset + 1) * BLOCK_SIZE,
                                    highlight_color=(200, 200, 200))
        self.draw_text_with_highlight("BLOCK", (self.boardWidth // 2 +6) * BLOCK_SIZE,
                                    ((self.board.GRID_HEIGHT / 2) + 2 * self.boardOffset + 3) * BLOCK_SIZE,
                                    highlight_color=(200, 200, 200))
...
class Tetris:
    ...
    def calculate_score(self, holes, max_height, lines_cleared,wells):
            ...
            if move == "ROTATE":
                ...
                for rotation in range(4):  # Assuming 4 possible rotations
                    ...
                    if self.is_valid_position(rotated_piece_copy, piece_x, piece_y, grid_copy):
                        ...
                        score = self.calculate_score(new_holes, max_height, lines_cleared,wells)
